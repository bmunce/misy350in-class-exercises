...
let bucket_list = ["Learn a new language", "Go to Iceland", "Skydive", 369];
...
let movie_list1 = ["1movie", "2movie", "3movie"];
let movie_list2 = ["12movie", "24movie", "2movie", "6movie", "3movie"];

for (let i = 0; i < movie_list1.length; i++) {
  for (let j = 0; j < movie_list2.length; i++) {
